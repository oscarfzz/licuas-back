...
SELECT go2.empresa_id AS empresa,
    ...
    (CASE WHEN
    (((((COALESCE(hc.importe_anterior, 0.00)) - COALESCE(hp.importe_anterior, 0.00))) + (((((COALESCE(hc.importe_presente, 0.00)) - COALESCE(hp.importe_presente, 0.00)) + ((COALESCE(hc.importe_mes_1, 0.00)) - COALESCE(hp.importe_mes_1, 0.00)) + ((COALESCE(hc.importe_mes_2, 0.00)) - COALESCE(hp.importe_mes_2, 0.00)) + ((COALESCE(hc.importe_mes_3, 0.00)) - COALESCE(hp.importe_mes_3, 0.00)) + ((COALESCE(hc.importe_mes_4, 0.00)) - COALESCE(hp.importe_mes_4, 0.00))) + ((COALESCE(hc.importe_proximo, 0.00)) - COALESCE(hp.importe_proximo, 0.00)) + ((COALESCE(hc.importe_siguiente, 0.00)) - COALESCE(hp.importe_siguiente, 0.00)) + ((COALESCE(hc.importe_pendiente, 0.00)) - COALESCE(hp.importe_pendiente, 0.00)))))) > 0 THEN
    ((((((COALESCE(hc.importe_anterior, 0.00)) - COALESCE(hp.importe_anterior, 0.00))) + (((((COALESCE(hc.importe_presente, 0.00)) - COALESCE(hp.importe_presente, 0.00)) + ((COALESCE(hc.importe_mes_1, 0.00)) - COALESCE(hp.importe_mes_1, 0.00)) + ((COALESCE(hc.importe_mes_2, 0.00)) - COALESCE(hp.importe_mes_2, 0.00)) + ((COALESCE(hc.importe_mes_3, 0.00)) - COALESCE(hp.importe_mes_3, 0.00)) + ((COALESCE(hc.importe_mes_4, 0.00)) - COALESCE(hp.importe_mes_4, 0.00))) + ((COALESCE(hc.importe_proximo, 0.00)) - COALESCE(hp.importe_proximo, 0.00)) + ((COALESCE(hc.importe_siguiente, 0.00)) - COALESCE(hp.importe_siguiente, 0.00)) + ((COALESCE(hc.importe_pendiente, 0.00)) - COALESCE(hp.importe_pendiente, 0.00))))))) * (COALESCE(hh.cf_acreedor, 0.00) / 100) ELSE
    ((((((COALESCE(hc.importe_anterior, 0.00)) - COALESCE(hp.importe_anterior, 0.00))) + (((((COALESCE(hc.importe_presente, 0.00)) - COALESCE(hp.importe_presente, 0.00)) + ((COALESCE(hc.importe_mes_1, 0.00)) - COALESCE(hp.importe_mes_1, 0.00)) + ((COALESCE(hc.importe_mes_2, 0.00)) - COALESCE(hp.importe_mes_2, 0.00)) + ((COALESCE(hc.importe_mes_3, 0.00)) - COALESCE(hp.importe_mes_3, 0.00)) + ((COALESCE(hc.importe_mes_4, 0.00)) - COALESCE(hp.importe_mes_4, 0.00))) + ((COALESCE(hc.importe_proximo, 0.00)) - COALESCE(hp.importe_proximo, 0.00)) + ((COALESCE(hc.importe_siguiente, 0.00)) - COALESCE(hp.importe_siguiente, 0.00)) + ((COALESCE(hc.importe_pendiente, 0.00)) - COALESCE(hp.importe_pendiente, 0.00))))))) * (COALESCE(hh.cf_deudor, 0.00) / 100) END))
    AS importe,
    go2.participacion_licuas,
    COALESCE(( SELECT gc.importe
           FROM general_cambiodivisa gc
...
UNION
 SELECT go2.empresa_id AS empresa,
    ...
    'GastosFinancierosInternos'::text AS concepto,
    CASE WHEN
    (((COALESCE(hc.importe_presente, 0.00)) - COALESCE(hp.importe_presente, 0.00)) + ((COALESCE(hc.importe_mes_1, 0.00)) - COALESCE(hp.importe_mes_1, 0.00)) + ((COALESCE(hc.importe_mes_2, 0.00)) - COALESCE(hp.importe_mes_2, 0.00)) + ((COALESCE(hc.importe_mes_3, 0.00)) - COALESCE(hp.importe_mes_3, 0.00)) + ((COALESCE(hc.importe_mes_4, 0.00)) - COALESCE(hp.importe_mes_4, 0.00))) > 0 THEN
    ((((COALESCE(hc.importe_presente, 0.00)) - COALESCE(hp.importe_presente, 0.00)) + ((COALESCE(hc.importe_mes_1, 0.00)) - COALESCE(hp.importe_mes_1, 0.00)) + ((COALESCE(hc.importe_mes_2, 0.00)) - COALESCE(hp.importe_mes_2, 0.00)) + ((COALESCE(hc.importe_mes_3, 0.00)) - COALESCE(hp.importe_mes_3, 0.00)) + ((COALESCE(hc.importe_mes_4, 0.00)) - COALESCE(hp.importe_mes_4, 0.00)))) * (COALESCE(hh.cf_acreedor, 0.00) / 100) ELSE
    ((((COALESCE(hc.importe_presente, 0.00)) - COALESCE(hp.importe_presente, 0.00)) + ((COALESCE(hc.importe_mes_1, 0.00)) - COALESCE(hp.importe_mes_1, 0.00)) + ((COALESCE(hc.importe_mes_2, 0.00)) - COALESCE(hp.importe_mes_2, 0.00)) + ((COALESCE(hc.importe_mes_3, 0.00)) - COALESCE(hp.importe_mes_3, 0.00)) + ((COALESCE(hc.importe_mes_4, 0.00)) - COALESCE(hp.importe_mes_4, 0.00)))) * (COALESCE(hh.cf_deudor, 0.00) / 100) END AS importe,
    go2.participacion_licuas,
    COALESCE(( SELECT gc.importe
           FROM general_cambiodivisa gc
          WHERE ((go2.divisa_id = gc.divisa_id) AND (gc.year = hh.year) AND (gc.cuarto = hh.cuarto))), 0.00) AS conversion_euros
...
UNION
 SELECT go2.empresa_id AS empresa,
    ...
    ((((COALESCE(hc.importe_presente, 0.00)) - COALESCE(hp.importe_presente, 0.00)) + ((COALESCE(hc.importe_mes_1, 0.00)) - COALESCE(hp.importe_mes_1, 0.00)) + ((COALESCE(hc.importe_mes_2, 0.00)) - COALESCE(hp.importe_mes_2, 0.00)) + ((COALESCE(hc.importe_mes_3, 0.00)) - COALESCE(hp.importe_mes_3, 0.00)) + ((COALESCE(hc.importe_mes_4, 0.00)) - COALESCE(hp.importe_mes_4, 0.00))) + ((COALESCE(hc.importe_proximo, 0.00)) - COALESCE(hp.importe_proximo, 0.00)) + ((COALESCE(hc.importe_siguiente, 0.00)) - COALESCE(hp.importe_siguiente, 0.00)) + ((COALESCE(hc.importe_pendiente, 0.00)) - COALESCE(hp.importe_pendiente, 0.00))) > 0 THEN
    (((((COALESCE(hc.importe_presente, 0.00)) - COALESCE(hp.importe_presente, 0.00)) + ((COALESCE(hc.importe_mes_1, 0.00)) - COALESCE(hp.importe_mes_1, 0.00)) + ((COALESCE(hc.importe_mes_2, 0.00)) - COALESCE(hp.importe_mes_2, 0.00)) + ((COALESCE(hc.importe_mes_3, 0.00)) - COALESCE(hp.importe_mes_3, 0.00)) + ((COALESCE(hc.importe_mes_4, 0.00)) - COALESCE(hp.importe_mes_4, 0.00))) + ((COALESCE(hc.importe_proximo, 0.00)) - COALESCE(hp.importe_proximo, 0.00)) + ((COALESCE(hc.importe_siguiente, 0.00)) - COALESCE(hp.importe_siguiente, 0.00)) + ((COALESCE(hc.importe_pendiente, 0.00)) - COALESCE(hp.importe_pendiente, 0.00)))) * (COALESCE(hh.cf_acreedor, 0.00) / 100) ELSE
    (((((COALESCE(hc.importe_presente, 0.00)) - COALESCE(hp.importe_presente, 0.00)) + ((COALESCE(hc.importe_mes_1, 0.00)) - COALESCE(hp.importe_mes_1, 0.00)) + ((COALESCE(hc.importe_mes_2, 0.00)) - COALESCE(hp.importe_mes_2, 0.00)) + ((COALESCE(hc.importe_mes_3, 0.00)) - COALESCE(hp.importe_mes_3, 0.00)) + ((COALESCE(hc.importe_mes_4, 0.00)) - COALESCE(hp.importe_mes_4, 0.00))) + ((COALESCE(hc.importe_proximo, 0.00)) - COALESCE(hp.importe_proximo, 0.00)) + ((COALESCE(hc.importe_siguiente, 0.00)) - COALESCE(hp.importe_siguiente, 0.00)) + ((COALESCE(hc.importe_pendiente, 0.00)) - COALESCE(hp.importe_pendiente, 0.00)))) * (COALESCE(hh.cf_deudor, 0.00) / 100) END AS importe, 
    go2.participacion_licuas,
    COALESCE(( SELECT gc.importe
           FROM general_cambiodivisa gc
          WHERE ((go2.divisa_id = gc.divisa_id) AND (gc.year = hh.year) AND (gc.cuarto = hh.cuarto))), 0.00) AS conversion_euros
...
UNION
 SELECT go2.empresa_id AS empresa,
    ...
    'ejercicioActual'::text AS periodo,
    'CapitalFinanciero'::text AS concepto,
    (((COALESCE(hc.importe_presente, 0.00)) - COALESCE(hp.importe_presente, 0.00)) + ((COALESCE(hc.importe_mes_1, 0.00)) - COALESCE(hp.importe_mes_1, 0.00)) + ((COALESCE(hc.importe_mes_2, 0.00)) - COALESCE(hp.importe_mes_2, 0.00)) + ((COALESCE(hc.importe_mes_3, 0.00)) - COALESCE(hp.importe_mes_3, 0.00)) + ((COALESCE(hc.importe_mes_4, 0.00)) - COALESCE(hp.importe_mes_4, 0.00)))
    AS importe,
    go2.participacion_licuas,
    COALESCE(( SELECT gc.importe
           FROM general_cambiodivisa gc
...
UNION
 SELECT go2.empresa_id AS empresa,
    ...
    'TotalPrevision'::text AS periodo,
    'CapitalFinanciero'::text AS concepto,
    ((((COALESCE(hc.importe_presente, 0.00)) - COALESCE(hp.importe_presente, 0.00)) + ((COALESCE(hc.importe_mes_1, 0.00)) - COALESCE(hp.importe_mes_1, 0.00)) + ((COALESCE(hc.importe_mes_2, 0.00)) - COALESCE(hp.importe_mes_2, 0.00)) + ((COALESCE(hc.importe_mes_3, 0.00)) - COALESCE(hp.importe_mes_3, 0.00)) + ((COALESCE(hc.importe_mes_4, 0.00)) - COALESCE(hp.importe_mes_4, 0.00))) + ((COALESCE(hc.importe_proximo, 0.00)) - COALESCE(hp.importe_proximo, 0.00)) + ((COALESCE(hc.importe_siguiente, 0.00)) - COALESCE(hp.importe_siguiente, 0.00)) + ((COALESCE(hc.importe_pendiente, 0.00)) - COALESCE(hp.importe_pendiente, 0.00)))
    AS importe,
    go2.participacion_licuas,
    COALESCE(( SELECT gc.importe
           FROM general_cambiodivisa gc
...
UNION
 SELECT go2.empresa_id AS empresa,
    ...
    'FinObra'::text AS periodo,
    'CapitalFinanciero'::text AS concepto,
    ((((COALESCE(hc.importe_anterior, 0.00)) - COALESCE(hp.importe_anterior, 0.00))) + (((((COALESCE(hc.importe_presente, 0.00)) - COALESCE(hp.importe_presente, 0.00)) + ((COALESCE(hc.importe_mes_1, 0.00)) - COALESCE(hp.importe_mes_1, 0.00)) + ((COALESCE(hc.importe_mes_2, 0.00)) - COALESCE(hp.importe_mes_2, 0.00)) + ((COALESCE(hc.importe_mes_3, 0.00)) - COALESCE(hp.importe_mes_3, 0.00)) + ((COALESCE(hc.importe_mes_4, 0.00)) - COALESCE(hp.importe_mes_4, 0.00))) + ((COALESCE(hc.importe_proximo, 0.00)) - COALESCE(hp.importe_proximo, 0.00)) + ((COALESCE(hc.importe_siguiente, 0.00)) - COALESCE(hp.importe_siguiente, 0.00)) + ((COALESCE(hc.importe_pendiente, 0.00)) - COALESCE(hp.importe_pendiente, 0.00))))) AS importe,
    go2.participacion_licuas,
    COALESCE(( SELECT gc.importe
           FROM general_cambiodivisa gc
          WHERE ((go2.divisa_id = gc.divisa_id) AND (gc.year = hh.year) AND (gc.cuarto = hh.cuarto))), 0.00) AS conversion_euros
...
UNION
 SELECT go2.empresa_id AS empresa,
    ...
    'Objetivos'::text AS periodo,
    'CapitalFinanciero'::text AS concepto,
    ((((((COALESCE(hh.importe_contrato_anterior, 0.00) + COALESCE(hh.importe_ampliacion_anterior, 0.00)) + (COALESCE(hh.importe_contrato_consolidado, 0.00) + COALESCE(hh.importe_ampliacion_consolidado, 0.00))) + (((((((((((((((COALESCE(hp2.importe_contrato_mes_1, 0.00) + COALESCE(hp2.importe_contrato_mes_2, 0.00)) + COALESCE(hp2.importe_contrato_mes_3, 0.00)) + COALESCE(hp2.importe_contrato_mes_4, 0.00)) + COALESCE(hp2.importe_contrato_resto, 0.00)) + COALESCE(hp2.importe_contrato_proximo, 0.00)) + COALESCE(hp2.importe_contrato_siguiente, 0.00)) + COALESCE(hp2.importe_contrato_pendiente, 0.00)) + COALESCE(hp2.importe_ampliaciones_mes_1, 0.00)) + COALESCE(hp2.importe_ampliaciones_mes_2, 0.00)) + COALESCE(hp2.importe_ampliaciones_mes_3, 0.00)) + COALESCE(hp2.importe_ampliaciones_mes_4, 0.00)) + COALESCE(hp2.importe_ampliaciones_resto, 0.00)) + COALESCE(hp2.importe_ampliaciones_proximo, 0.00)) + COALESCE(hp2.importe_ampliaciones_siguiente, 0.00)) + COALESCE(hp2.importe_ampliaciones_pendiente, 0.00))) - (((((((((COALESCE(hh.importe_coste_directo_anterior, 0.00) + COALESCE(hh.importe_coste_directo_consolidado, 0.00)) + COALESCE(hp2.importe_coste_mes_1, 0.00)) + COALESCE(hp2.importe_coste_mes_2, 0.00)) + COALESCE(hp2.importe_coste_mes_3, 0.00)) + COALESCE(hp2.importe_coste_mes_4, 0.00)) + COALESCE(hp2.importe_coste_resto, 0.00)) + COALESCE(hp2.importe_coste_proximo, 0.00)) + COALESCE(hp2.importe_coste_siguiente, 0.00)) + COALESCE(hp2.importe_coste_pendiente, 0.00)))) - (((((COALESCE(hc.importe_anterior, 0.00)) - COALESCE(hp.importe_anterior, 0.00))) + (((((COALESCE(hc.importe_presente, 0.00)) - COALESCE(hp.importe_presente, 0.00)) + ((COALESCE(hc.importe_mes_1, 0.00)) - COALESCE(hp.importe_mes_1, 0.00)) + ((COALESCE(hc.importe_mes_2, 0.00)) - COALESCE(hp.importe_mes_2, 0.00)) + ((COALESCE(hc.importe_mes_3, 0.00)) - COALESCE(hp.importe_mes_3, 0.00)) + ((COALESCE(hc.importe_mes_4, 0.00)) - COALESCE(hp.importe_mes_4, 0.00))) + ((COALESCE(hc.importe_proximo, 0.00)) - COALESCE(hp.importe_proximo, 0.00)) + ((COALESCE(hc.importe_siguiente, 0.00)) - COALESCE(hp.importe_siguiente, 0.00)) + ((COALESCE(hc.importe_pendiente, 0.00)) - COALESCE(hp.importe_pendiente, 0.00))))))) 
    AS importe,
    go2.participacion_licuas,
    COALESCE(( SELECT gc.importe
           FROM general_cambiodivisa gc
...
UNION
 SELECT go2.empresa_id AS empresa,
    ...
    'TotalPrevision'::text AS periodo,
    'Cobros'::text AS concepto,
    ((((((COALESCE(hcobro.importe_presente, 0.00) + COALESCE(hcobro.importe_mes_1, 0.00)) + COALESCE(hcobro.importe_mes_2, 0.00)) + COALESCE(hcobro.importe_mes_3, 0.00)) + COALESCE(hcobro.importe_mes_4, 0.00)) + COALESCE(hcobro.importe_resto, 0.00)) + COALESCE(hcobro.importe_proximo, 0.00) + COALESCE(hcobro.importe_siguiente, 0.00) + COALESCE(hcobro.importe_pendiente, 0.00))
    AS importe,
    go2.participacion_licuas,
    COALESCE(( SELECT gc.importe
           FROM general_cambiodivisa gc
